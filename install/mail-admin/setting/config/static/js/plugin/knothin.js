...
var knothin = {
	...
	editor : function(){
		...
		$("#pageInfo p").bind('click', function(e) {

			knothin.variable.target = utils.urlString("id");
	        ...
	        knothin.variable.editor = KothingEditor.create("sample", {
	            ...
	            callBackSave: function(contents) {
	            	...
	            	if(knothin.variable.target != undefined){
	            		mytemplate.action.updateTemplateContent({id :knothin.variable.target, content : $mainPage.html()});
	            	}
